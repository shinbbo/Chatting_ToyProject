...
CMessageMapDlg::CMessageMapDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_MESSAGEMAP_DIALOG, pParent)
{
...
// CMessageMapDlg 메시지 처리기

BOOL CMessageMapDlg::OnInitDialog()
{
...
void CMessageMapDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
//  이 함수를 호출합니다.
HCURSOR CMessageMapDlg::OnQueryDragIcon()
{
