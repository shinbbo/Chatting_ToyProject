...
CNMEADlg::CNMEADlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_NMEA_DIALOG, pParent)
{
	m_hIcon = AfxGetApp()->LoadIcon(IDR_MAINFRAME);
}

void CNMEADlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
	DDX_Control(pDX, IDC_LIST1, m_ListBoxRead);
}

BEGIN_MESSAGE_MAP(CNMEADlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
...
void CNMEADlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
//  이 함수를 호출합니다.
HCURSOR CNMEADlg::OnQueryDragIcon()
{
...
void CNMEADlg::OnBnClickedButtonRead()
{
